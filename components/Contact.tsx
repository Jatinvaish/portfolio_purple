  ...
  const handleSubmit = async (e:any) => {
    ...
    try {
      ...
      'template_fo4493g',
        {
          from_name: form.name,
          to_name: "Jatin Vaishnav",
          from_email: form.email,
          to_email: "1195jatinvaishnav@gmail.com",
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-400 text-sm">+91 9664977979</p>
                    </div>
                  </a>
                  ...
                  >
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-400 text-sm">@jatinvaishnav</p>
                    </div>
                  </a>
                </div>
              </div>

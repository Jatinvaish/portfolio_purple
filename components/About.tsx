              ...
              <div className="lg:col-span-2 space-y-10">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    A passionate Full-Stack Developer with a knack for turning complex problems into elegant, scalable solutions..
                  </p>
                </div>
                ...
                <div className="flex flex-wrap gap-3">
                  {[
                    'Full Stack development', 'Scalable Applications', 'Database design',
                    'Agile Methodology', 'Wordpress Development', 'E-commerce', '3D Design',
                  ].map((skill, index) => (
                    <span
                      key={index}
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-0">
              <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-6 gap-8">
                {[
                  ...
                  <div key={idx} className="min-w-[165px]  glass-card p-6 rounded-xl space-y-4">
                    <h4 className="text-lg font-semibold text-white/90">{category.title}</h4>
                    <div className="space-y-4">
                      {category.skills.map((skill, index) => (
                        <div key={index} className="space-y-2">
